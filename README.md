...
* [Byte-size tutorials](https://gist.github.com/honkskillet/bd1f72223dd8e06b5ce6)

#### Язык программирования Rust

* [Rust Documentation](https://doc.rust-lang.org/)
* [The Rust Programming Language](http://kgv.gitbooks.io/rust_book_ru/content/)
* [The Rust Programming Language на русском языке](https://github.com/ruRust/rust_book_ru)
* [Rust by Example](http://rustbyexample.com/)
* [Руководство Rust](https://github.com/ruslux/rustification/blob/master/rust_guide.md)
